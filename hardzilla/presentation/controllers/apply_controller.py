...
class ApplyController:
    ...
    def __init__(
        ...
        Args:
            ...
            install_extensions: Use case for installing extensions
            uninstall_extensions: Use case for uninstalling extensions
    ...
    def handle_refresh_installed_extensions(self) -> None:
        ...
        if not self.view_model.firefox_path:
            logger.debug("No firefox_path set, skipping installed extensions refresh")
